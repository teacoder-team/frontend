...
const faqs = [
	...
	},
	{
		...
		// 	<>
		// 		<p>
		// 			Да, подписку можно оплатить из любой страны с помощью
		// 			международных банковских карт: Visa, MasterCard, UnionPay и
		// 			American Express.
		// 		</p>
		// 	</>
		// )
		answer: 'В данное время оплата международными банковскими картами временно недоступна. Мы приостановили обработку трансграничных платежей в связи с обновлением платёжной инфраструктуры и переходом на нового провайдера.'
	},
	{
