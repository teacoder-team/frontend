...
const faqs = [
	...
	},
	{
		...
		answer: (
			<>
				<p>
					Да, подписку можно оплатить из любой страны. Для
					международных пользователей доступны следующие способы
					оплаты:
				</p>
				<ul className='mt-2 list-inside list-disc space-y-1'>
					<li>
						...
						<strong>UnionPay</strong> и{' '}
						<strong>American Express</strong>.
					</li>
					<li>
						Криптовалютные платежи для пользователей, предпочитающих
						цифровые валюты.
					</li>
				</ul>
				<p className='mt-2'>
					После выбора метода оплаты система автоматически предложит
					доступные варианты в зависимости от вашей страны и валюты.
				</p>
			</>
		)
	},
